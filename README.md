...
**正在把想法做成能上线、能演示、能放进简历的作品集项目。**

从 0 到 1 做 Web 项目，重点在：**前后端整合、交互体验、产品包装、可部署展示**。
...
- 做适合校招 / 面试展示的完整项目，而不只是练习代码片段
- 把项目打磨成 **GitHub 可看、README 可读、演示可讲** 的作品集
- 继续补强自己的全栈能力：前端体验、后端接口、数据库、部署上线
